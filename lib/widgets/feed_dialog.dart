...
class FeedDialog extends StatelessWidget {
        ...
        child: Column(
          children: [
            Container(
              ...
              child: Image.asset(prodAttr.imageUrl),
            ),
            Container(
              color: Theme.of(context).scaffoldBackgroundColor,
              child: Row(
  ...
  Widget dialogContent(BuildContext context, int index, Function fct) {
    ...
    List<String> _texts = [
      favs.getFavsItems.containsKey(productId) ? 'Đã thêm' : 'Yêu thích',
      'Xem sản phẩm',
      cart.getCartItems.containsKey(productId) ? 'Đã thêm' : 'Thêm vào giỏ'
    ];
