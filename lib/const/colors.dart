...
class ColorsConsts {
  ...
  static Color gradiendFStart = Color(0xFF209709); //purpleaccent 100
  static Color gradiendFEnd = Color(0xFF209709); //purple 100
  static Color endColor = Color(0xFFCE93D8); //purple 200
  static Color purple300 = Color(0xFFBA68C8); //purple 300
  static Color gradiendLEnd = Color(0xFF00BCD4); //purple 400
  static Color gradiendLStart = Color(0xFF00838F); //purpleaccent 700
